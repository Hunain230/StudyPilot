...
export async function suggestResources(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const prompt = `
      ...
      - URL (use a valid, real placeholder or well-known standard URL like geeksforgeeks.org, neetcode.io, khanacademy.org, w3schools.com, developer.mozilla.org, wikipedia.org, etc.)
      - Type: choose strictly from: VIDEO, ARTICLE, PAPER, BOOK, COURSE, TOOL, OTHER
      - Reason: 1 sentence explaining why this resource is highly beneficial for learning this specific topic.
