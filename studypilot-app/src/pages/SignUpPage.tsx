      ...
      <main className="flex-grow flex items-center justify-center px-margin-mobile md:px-margin-desktop py-12 relative overflow-hidden">
        ...
        <div className="glass-card w-full max-w-[480px] rounded-[24px] p-8 md:p-12 shadow-2xl relative z-10">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <h1 className="font-headline text-headline-lg text-on-surface mb-2">Start your journey to mastery</h1>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block font-label text-label-md text-on-surface-variant mb-2 ml-1" htmlFor="name">Full Name</label>
              <input
            ...
            <div>
              <label className="block font-label text-label-md text-on-surface-variant mb-2 ml-1" htmlFor="email">Email Address</label>
              <input
                className="input-soft w-full px-4 py-3.5 rounded-xl border-none font-body text-on-surface placeholder:text-outline-variant"
                id="email"
            ...
            <div>
              <label className="block font-label text-label-md text-on-surface-variant mb-2 ml-1" htmlFor="password">Password</label>
            ...
            <button
              className="gradient-btn w-full py-4 rounded-xl font-headline text-on-primary flex items-center justify-center gap-2 group text-lg mt-4"
              type="submit"
              disabled={loading}
            >
              {loading ? (
          ...
          <div className="mt-10 text-center">
            <p className="font-body text-body-sm text-on-surface-variant">
              ...
              <Link className="text-primary font-semibold hover:underline decoration-2 underline-offset-4" to="/login">Sign in</Link>
            </p>
          </div>
        </div>
      </main>
